#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri Apr 29 17:40:40 2011
...
class screenshotConfigDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_CHECKBOX, self.subsectionchecked, self.subsectioncheck)
    ...
    def subsectionchecked(self, event): # wxGlade: screenshotConfigDialog.<event_handler>
        print "Event handler `subsectionchecked' not implemented!"
        event.Skip()
